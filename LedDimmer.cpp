...
LedDimmer::LedDimmer(int buttonPin, int ledPin, int powerPin, uint16_t *modbus, int buttonBit, int stateBit, int maxValueIndex) {
...
void LedDimmer::onButtonPressed() {
...
void LedDimmer::onButtonReleased() {
    this->lightPressedTime = 0;
...
void LedDimmer::onButtonKeepsPressed() {
   if (this->lightSetupMode == 1) {
      return; //no need it 
   }
